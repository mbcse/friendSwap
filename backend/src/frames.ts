...
frames.get("/create", (_req: Request, res: Response) => {
  const html = frameHtml({
    title: "FriendSwap: Create Swap",
    imageUrl: "https://dummyimage.com/1200x630/111/fff&text=FriendSwap+Create",
    buttons: [
...
frames.get("/fulfill", (_req: Request, res: Response) => {
  ...
  const html = frameHtml({
    title,
    imageUrl: "https://dummyimage.com/1200x630/111/fff&text=FriendSwap+Fulfill",
    buttons: latest
