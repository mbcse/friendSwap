...
export default function App(
  { title }: AppProps = { title: "FriendSwap" }
) {
                  ...
                  {swap.completionTxHashes && (
                    <div className="text-xs text-gray-600 space-y-1 border-t pt-2">
                      ...
                      <div>
                        ...
                        <a 
                          href={`${swap.executionData.dstChainId === "11155111" ? "https://sepolia.etherscan.io" : "https://base-sepolia.blockscout.com"}/tx/${swap.completionTxHashes.dstTxHash}`}
                          target="_blank"
                      ...
                      <div>
                        ...
                        <a 
                          href={`${swap.executionData.srcChainId === "11155111" ? "https://sepolia.etherscan.io" : "https://base-sepolia.blockscout.com"}/tx/${swap.completionTxHashes.srcTxHash}`}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-blue-600 hover:text-blue-800 underline"
                        >
